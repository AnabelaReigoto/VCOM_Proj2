...
def main():
    ...
    # create SGDC classifier
    sgdc_classifier = SGDClassifier(random_state=42, max_iter=10)
    ...
    pred = sgdc_classifier.predict([some_digit]) 
    ...
    score = cross_val_score(sgdc_classifier,X_train, y_train,cv=3, scoring="accuracy")
    print(score)
    ...
    y_train_pred = cross_val_predict(sgdc_classifier,X_train,y_train, cv = 3)    
